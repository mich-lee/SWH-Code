...
# backpropRes = diffraction_model.P0.invertForwardPropagation(diffraction_model.P0.forwardPropagate(stageOutputs['S0'], dataIsPrePadded = False, doUnpadding = True), dataIsPrePadded = False, doUnpadding = True)
...
# ax_arr[1,0].imshow(diffraction_model.P0.forward(field_in).abs().cpu())
